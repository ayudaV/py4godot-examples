...
from py4godot.classes.core import NodePath, StringName
...
class hud(CanvasLayer):
	...
	def show_message(self, text: str) -> None:
		message_label = Label.cast(self.get_node(NodePath.new2("MessageLabel")))
		message_timer = Timer.cast(self.get_node(NodePath.new2("MessageTimer")))
	...
	def show_title(self):
		...
		Timer.cast(self.get_node(NodePath.new2("MessageTimer"))).timeout.disconnect(self.show_title)


	def show_start_button(self):
		start_button = Button.cast(self.get_node(NodePath.new2("StartButton")))
		start_button.show()
	def update_score(self, score: int) -> None:
		score_label = Label.cast(self.get_node(NodePath.new2("ScoreLabel")))
